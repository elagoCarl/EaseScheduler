  ...
  return (
    <div className="bg-cover bg-center bg-no-repeat h-screen w-screen flex items-center justify-center px-40 items"
      ...
      <section className='justify-center items-center text-center'>
        ...
        <form id='blueBox' className='bg-blue-500 p-80 items-center justify-center flex-col space-y-5 sm:p-60 w-[400px] sm:w-[450px]'>
          <div>
          ...
          <button id='signInBtn' type="submit" class="w-full text-white bg-violet-700 hover:bg-gray-500 font-medium rounded-lg text-sm py-2.5 text-center">Sign in</button>
        </form>
      </section>
    </div>
  )
