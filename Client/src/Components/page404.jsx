  ...
  return (
    <div className='flex justify-center items-center h-screen bg-black/85'>
      <div className='text-center'>
        ...
        <button onClick={() => navigate("/")} className='mt-6 px-10 py-4 bg-blue-600 text-white text-lg font-semibold rounded-md hover:bg-blue-800 transition duration-300 border-none'>
          Go Back?
        </button>
      </div>
    </div>
